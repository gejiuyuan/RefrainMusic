...
import { defineComponent, reactive, watch, provide } from 'vue';
import {
	useRoute,
	useRouter,
	LocationQuery,
...
export const baseSearchCate = [
	{ text: '歌曲', to: '/search/songs', type: 1, limit: PAGE_SIZE.DEFAULT },
	{
		...
		to: '/search/video',
		type: 1014,
		limit: PAGE_SIZE[COMPONENT_NAME.SEARCH_VIDEO],
	},
	{
		text: '专辑',
		to: '/search/album',
		type: 10,
		limit: PAGE_SIZE[COMPONENT_NAME.SEARCH_ALBUM],
	},
	{
		text: '歌单',
		to: '/search/songlist',
		type: 1000,
		limit: PAGE_SIZE[COMPONENT_NAME.SEARCH_SONGLIST],
	},
	{
		text: '歌词',
		to: '/search/lyric',
		type: 1006,
		limit: PAGE_SIZE[COMPONENT_NAME.SEARCH_LYRIC],
	},
	...
	{ text: '电台', to: '/search/radio', type: 1009, limit: PAGE_SIZE.DEFAULT },
	{
		...
		to: '/search/mv',
		type: 1004,
		limit: PAGE_SIZE[COMPONENT_NAME.SEARCH_MV],
	},
...
export default defineComponent({
	...
	setup(props, context) {
		...
		const searchCate = reactive(deepCopy<typeof baseSearchCate>(baseSearchCate));
