...
import refrainPic from '@assets/img/refrain.png';
...
export const LogicLayer = defineComponent({
	...
	setup() {
		...
		messageBus.on('successMessage', (...args: FuncParamsType<typeof message.success>) =>
			message.success(...args),
		);
		messageBus.on('warnMessage', (...args: FuncParamsType<typeof message.warning>) =>
			message.warning(...args),
		);
		messageBus.on('errorMessage', (...args: FuncParamsType<typeof message.error>) =>
			message.error(...args),
		);
